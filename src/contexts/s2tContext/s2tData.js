...
export const s2tData = {
  ...
  formOptions: {
    ...
    sportsOptions: [
      { value: 'soccer', text: 'Futebol' },
      { value: 'futsal', text: 'Futsal' },
      { value: 'basketball', text: 'Basquete' },
      { value: 'football', text: 'Futebol americano' },
      { value: 'volleyball', text: 'Vôlei' },
      { value: 'beach_volley', text: 'Vôlei de praia' },
      { value: 'footvolley', text: 'Futevôlei' },
      ...
      { value: 'martial-arts', text: 'Artes Marciais' },
      { value: 'gymnastics', text: 'Ginástica' },
