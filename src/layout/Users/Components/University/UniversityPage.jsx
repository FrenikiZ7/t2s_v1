...
import * as Styled from './UniversityPage-Styles';
...
export function UniversityPage() {
  ...
  return (
    <Styled.UniversityPageContainer>
      ...
      <GridLayout>
        ...
        <IconCard
          name={t('university_step_1_title')}
          onClick={() => handleExplanation('step-1')}
          active={explanation === 'step-1'}
          activecolor={theme.colors.primary}
        >
          <CheckIcon />
          <Subtitle text={t('university_step_1_title')} size={theme.sizes.small} uppercase as="h3" />
        ...
        <IconCard
          name={t('university_step_2_title')}
          onClick={() => handleExplanation('step-2')}
          active={explanation === 'step-2'}
          activecolor={theme.colors.primary}
        >
          <PersonEditIcon />
          <Subtitle text={t('university_step_2_title')} size={theme.sizes.small} uppercase as="h3" />
        ...
        <IconCard
          name={t('university_step_3_title')}
          onClick={() => handleExplanation('step-3')}
          active={explanation === 'step-3'}
          activecolor={theme.colors.primary}
        >
          <VideoAddIcon />
          <Subtitle text={t('university_step_3_title')} size={theme.sizes.small} uppercase as="h3" />

          {explanation === 'step-3' && (
            <Styled.Explanation>
              <ListContainer>
                <ListItem color={theme.colors.primary}>
                  {t('university_step_3_part_1')}
                </ListItem>

                <ListItem color={theme.colors.primary}>
                  {t('university_step_3_part_2')}
                </ListItem>

                <ListItem color={theme.colors.primary}>
                  {t('university_step_3_part_3')}
                </ListItem>
              </ListContainer>
            </Styled.Explanation>
          )}
        ...
        <IconCard
          name={t('university_step_4_title')}
          onClick={() => handleExplanation('step-4')}
          active={explanation === 'step-4'}
          activecolor={theme.colors.primary}
        >
          <BookOpenIcon />
          <Subtitle text={t('university_step_4_title')} size={theme.sizes.small} uppercase as="h3" />

          {explanation === 'step-4' && (
            <Styled.Explanation>
              <ListContainer>
                <ListItem color={theme.colors.primary}>
                  {t('university_step_4_part_1')}
                </ListItem>

                <ListItem color={theme.colors.primary}>
                  {t('university_step_4_part_2')}
                </ListItem>

                <ListItem color={theme.colors.primary}>
                  {t('university_step_4_part_3')}
                </ListItem>

                <ListItem color={theme.colors.primary}>
                  {t('university_step_4_part_4')}
                </ListItem>
              </ListContainer>
            </Styled.Explanation>
          )}
