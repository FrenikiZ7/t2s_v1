...
import * as Styled from './FanPage-Styles';
  ...
  return (
    <Styled.FanPageContainer>
      ...
      <GridLayout>
        ...
        <IconCard
          name={t('fan_step_1_title')}
          onClick={() => handleExplanation('step-1')}
          active={explanation === 'step-1'}
          activecolor={theme.colors.primary}
        >
          <CheckIcon />
          <Subtitle text={t('fan_step_1_title')} size={theme.sizes.small} uppercase as="h3" />
        ...
        <IconCard
          name={t('fan_step_2_title')}
          onClick={() => handleExplanation('step-2')}
          active={explanation === 'step-2'}
          activecolor={theme.colors.primary}
        >
          <PersonEditIcon />
          <Subtitle text={t('fan_step_2_title')} size={theme.sizes.small} uppercase as="h3" />
        ...
        <IconCard
          name={t('fan_step_3_title')}
          onClick={() => handleExplanation('step-3')}
          active={explanation === 'step-3'}
          activecolor={theme.colors.primary}
        >
          <VideoAddIcon />
          <Subtitle text={t('fan_step_3_title')} size={theme.sizes.small} uppercase as="h3" />
        ...
        <IconCard
          name={t('fan_step_4_title')}
          onClick={() => handleExplanation('step-4')}
          active={explanation === 'step-4'}
          activecolor={theme.colors.primary}
        >
          <BookOpenIcon />
          <Subtitle text={t('fan_step_4_title')} size={theme.sizes.small} uppercase as="h3" />
